  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg font-body font-semibold ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        warm: "bg-accent text-foreground hover:bg-accent/80 shadow-md hover:shadow-lg",
        hero: "bg-primary text-primary-foreground hover:bg-primary/85 shadow-lg hover:shadow-xl text-base",
      },
      size: {
